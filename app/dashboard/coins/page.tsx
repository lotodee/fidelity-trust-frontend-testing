    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {cards.map((card) => (
            <Card key={card.id} className="bg-gradient-to-br from-navy-800 to-navy-950 text-white overflow-hidden">
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>Create a new virtual card for online purchases.</DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4">
                <div className="space-y-2">
                  <Label htmlFor="cardName">Card Name</Label>
                  <Input id="cardName" placeholder="Shopping Card" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="initialFunding">Initial Funding (Optional)</Label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">$</span>
                    <Input id="initialFunding" type="number" placeholder="0.00" className="pl-8" />
                  </div>
                </div>
              </div>
              <DialogFooter>
                <Button className="bg-emerald-500 hover:bg-emerald-600">Create Card</Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
        </div>
