...
//             className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-full max-w-sm sm:max-w-md md:max-w-lg"
//           >
//             <div
//               className={cn(
//                 "relative flex items-start gap-4 px-6 py-5 rounded-xl shadow-lg border",
//                 styles[type]
//               )}
//             >
//               {/* Icon Container */}
//               <div className={cn("flex-shrink-0 p-2 rounded-lg", getIconBackground())}>
//                 {icons[type]}
//               </div>
      ...
      {isVisible && (
        <>
          ...
          <motion.div
            ...
            exit={{ opacity: 0, y: -20, scale: 0.95 }}
            transition={{ type: "spring", damping: 20, stiffness: 300 }}
            className="fixed top-0 z-50 flex items-center justify-center top-0  px-4"
          >
            <div
              className={cn(
